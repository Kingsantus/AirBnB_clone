...
class TestHBNBCommand_prompting(unittest.TestCase):
    """These are the unittests for testing prompting of the HBNB command interpreter."""
...
class TestHBNBCommand_help(unittest.TestCase):
    """These are the unittests for testing help messages of the HBNB command interpreter."""

    def test_help_quit(self):
        h = "This is the quit command used to exit the program."
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_help_create(self):
        h = ("Usage: create <class>\n        "
             "This creates a new class instance and prints the id.")
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("help create"))
            self.assertEqual(h, output.getvalue().strip())

    def test_help_EOF(self):
        h = "This is the EOF signal used to exit the program."
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_help_show(self):
        h = ("Usage: show <class> <id> or <class>.show(<id>)\n        "
             "This displays the string representation of a class instance of"
             " a given id.")
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_help_all(self):
        h = ("Usage: all or all <class> or <class>.all()\n        "
             "This displays the string representations of all instances of a given class"
             ".\n        If no class is specified, it displays all the instantiated "
             "objects.")
        with patch("sys.stdout", new=StringIO()) as output:
...
class TestHBNBCommand_exit(unittest.TestCase):
    """These are the unittests used for testing exit from the HBNB command interpreter."""
...
class TestHBNBCommand_create(unittest.TestCase):
    """These are the unittests used for testing create from the HBNB command interpreter."""
    ...
    def test_create_invalid_class(self):
        correct = "** the class does not exist **"
        with patch("sys.stdout", new=StringIO()) as output:
...
class TestHBNBCommand_show(unittest.TestCase):
    """These are the unittests used for testing show from the HBNB command interpreter"""
...
class TestHBNBCommand_destroy(unittest.TestCase):
    """These are the unittests used for testing destroy from the HBNB command interpreter."""
...
class TestHBNBCommand_all(unittest.TestCase):
    """these are the unittests used for testing all of the HBNB command interpreter."""
...
class TestHBNBCommand_update(unittest.TestCase):
    """These are the unittests used for testing update from the HBNB command interpreter."""
...
class TestHBNBCommand_count(unittest.TestCase):
    """These are the unittests used for testing count method of HBNB comand interpreter."""
