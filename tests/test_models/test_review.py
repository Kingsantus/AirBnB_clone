...
class TestReview_instantiation(unittest.TestCase):
    """These are the unittests used for testing instantiation of the Review class."""
...
class TestReview_save(unittest.TestCase):
    """These are the unittests used for testing save method of the Review class."""
...
class TestReview_to_dict(unittest.TestCase):
    """These are the unittests used for testing to_dict method of the Review class."""
