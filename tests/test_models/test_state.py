...
class TestState_instantiation(unittest.TestCase):
    """These are the unittests used for testing instantiation of the State class."""
...
class TestState_save(unittest.TestCase):
    """These are the unittests used for testing save method of the State class."""
...
class TestState_to_dict(unittest.TestCase):
    """These are the unittests used for testing to_dict method of the State class."""
