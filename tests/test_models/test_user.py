#!/usr/bin/python3
"""This script defines the unittests for models/user.py.
...
class TestUser_instantiation(unittest.TestCase):
    """These are the unittests used for testing instantiation of the User class."""
...
class TestUser_save(unittest.TestCase):
    """These are the unittests used for testing save method of the  class."""
...
class TestUser_to_dict(unittest.TestCase):
    """These are the unittests used for testing to_dict method of the User class."""
