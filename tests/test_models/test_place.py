...
class TestPlace_instantiation(unittest.TestCase):
    """These are the unittests used for testing instantiation of the Place class."""
...
class TestPlace_save(unittest.TestCase):
    """These are the unittests used for testing save method of the Place class."""
...
class TestPlace_to_dict(unittest.TestCase):
    """These are the unittests used for testing to_dict method of the Place class."""
